    ...
    <div class="bg-white shadow-sm ring-1 ring-slate-200 rounded-xl p-6" id="panel" style="display:none;">
      ...
      <div id="manualFallback" class="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg" style="display:none;">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h4 class="text-sm font-medium text-amber-800">Build Failed</h4>
            <p class="text-sm text-amber-700 mt-1">The automated build failed. Please check your build configuration or run build commands manually.</p>
          </div>
        </div>
      </div>
